            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-gray-500">
                    Get notified when posts are published or scheduled
                  </p>
                </div>
                <Switch />
              </div>
        ...
        <TabsContent value="preferences" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Customize your workspace and content generation settings
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between">
              ...
              <div className="space-y-2">
                ...
                <Input id="llmProvider" placeholder="OpenAI GPT-4" />
              </div>
            </CardContent>
          </Card>
        </TabsContent>
